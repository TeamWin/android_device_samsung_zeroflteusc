...
-include vendor/samsung/zeroflteusc/BoardConfigVendor.mk

TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := zeroflteusc
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset  0x01000000 --dt device/samsung/zeroflteusc/dtb --tags_offset 0x0000100
...
TARGET_RECOVERY_INITRC := device/samsung/zeroflteusc/init.rc

# Kernel Configs
#TARGET_KERNEL_SOURCE := kernel/samsung/zeroflteusc
#TARGET_KERNEL_CONFIG := exynos7420-zeroflteusc_tmo_defconfig
...
#VARIANT_CONFIG :=
#TIMA_DEFCONFIG :=
TARGET_PREBUILT_KERNEL := device/samsung/zeroflteusc/kernAl
